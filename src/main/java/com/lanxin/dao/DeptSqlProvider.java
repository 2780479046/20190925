...
import com.lanxin.bean.DeptExample.Criteria;
import com.lanxin.bean.DeptExample.Criterion;
...
public class DeptSqlProvider {
    ...
    protected void applyWhere(DeptExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
